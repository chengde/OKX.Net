...
public interface IOKXRestClientUnifiedApiExchangeData
{
    ...
    /// <param name="ct">Cancellation Token</param>
    /// <returns></returns>
    Task<WebCallResult<IEnumerable<OKXBlockTicker>>> GetMarketBlockTickersAsync(InstrumentType instrumentType, string? underlying = null, string? instrumentFamily = null, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation Token</param>
    /// <returns></returns>
    Task<WebCallResult<IEnumerable<OKXBlockTrade>>> GetPublicBlockTradesAsync(string symbol, CancellationToken ct = default);
